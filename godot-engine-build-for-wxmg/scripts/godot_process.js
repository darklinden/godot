...
// Transpile ES2020 syntax (optional chaining ?., nullish coalescing ??) for WeChat Mini Game
try {
    execSync(
        "npx esbuild ./bin/.web_zip/godot.js --target=es2018 --outfile=./bin/.web_zip/godot.js --allow-overwrite",
        { stdio: "inherit" }
    )
    console.log("transpiled to es2018")
} catch (e) {
